...
const en: Dict = {
  ...
  sigPage: {
    title: "Signature photo for a form — set the size and the KB, free",
    h1: "Prepare a signature for an upload",
    lead: "Photograph your signature on white paper, and this cleans the paper away, crops to the ink and hits the size the form asks for. It runs in the browser, so the signature never leaves your device.",
    threshold: "Ink threshold",
    thresholdHint: "Slide until the paper is clean and the strokes are still whole. Too low and the thin ends vanish; too high and the shadows stay.",
    ...
    noMin: "No minimum",
    result: "Result:",
    noInk: "Nothing dark enough was found. Raise the threshold, or photograph the paper in brighter, flatter light.",
    tooSmall: "Below the minimum the form wants. Try a larger width — a bigger picture carries more bytes.",
    tooBig: "Over the limit. Try a smaller width.",
    download: "Download",
    fileLabel: "Signature",
    whenToUse: "Why a separate page",
    whenToUseBody: "Forms that ask for a signature state the pixel width and a range in kilobytes, and the range has a floor as well as a ceiling — a clean signature compresses so well that it falls under the minimum and is refused for being too small. That is the half of the rule most tools ignore, so it is a control here rather than a surprise.",
  },

  rejectedPage: {
    title: "Photo rejected? What the portal meant, and how to check yours",
    h1: "Your photo was rejected. Why?",
    lead: "Upload forms refuse a file and then explain almost nothing. Here is what each refusal usually means, in the words the portals use — and a checker that measures your file and tells you which rule it actually breaks.",
    checkIt: "Check my photo",
    r1h: "\"Please select a 35x45 mm photo\"",
    r1b: "The proportions are wrong, not the millimetres — a portal cannot know how large you intend to print. It measured the ratio of your file and it was not 35:45. A photo cropped square, or to 3:4, fails this even at a huge resolution.",
    r2h: "The upload fails with no message at all",
    r2b: "Almost always the weight. Portals set a ceiling in kilobytes and many refuse silently when it is passed. A few also set a floor and refuse a file that is too small, which happens when a photo has been compressed hard to get under the ceiling.",
    r3h: "\"Face too large\" or \"face too small\"",
    r3b: "Head height is a share of the frame, and it is measured from the chin to the top of the head — including hair, which is what most people get wrong. Most countries want 70 to 80 per cent of the height; the United States wants 50 to 69, which is why an American photo looks so different.",
    r4h: "\"Background is not uniform\"",
    r4b: "A wall is rarely as plain as it looks: a shadow behind the head, a colour gradient across the frame, or a door frame in one corner. It is also possible to fail this by removing the background badly and leaving a halo around the hair.",
    r5h: "\"Photo appears edited\"",
    r5b: "Some authorities refuse any photo that has been through software, and a few of the documents on this site say so on their page. Where that rule exists, use the tool to check the framing and submit an unedited photograph.",
    r6h: "It was accepted last year and refused now",
    r6b: "Requirements change and portals change quietly. Recheck the size against the current specification rather than against the file that worked before — every page here states when it was last verified and against which source.",
  },
